			...
			<section class="home-about-area section-gap aboutus-about" id="about">
				<div class="container">
						 <div class="wrap-table100">
							...
							$query = "SELECT a.ID AS CONTACT_ID , a.contact_first, a.contact_last,a.company,a.industry, a.address,a.address_city, a.phone, 
									   CONCAT(b.Name_Last, ', ',b.Name_First) as fldname FROM tblcontact a
									   left join tblusers AS b on sales_repid=b.id";
							...
							if (($result)||(mysql_errno == 0))
							{
								if ($rowcount>0)
							    {
									...
									while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
									{
									  ...
									  foreach ($row as $data)
									  {
										echo "<td align='center'><a href='editcontact?aid=". $row['CONTACT_ID'] ."'>". $data . "</a></td>";
									  }
									  echo '</tr></tbody>';
									}
						...
						<form class="form-inline" method="post" action="pdf_contact" target="_blank">
