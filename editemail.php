   ...
   // define variables and set to empty values
	{
		...
		if ($_POST["fldemail1"] === $_POST["fldemail2"]) {

		$fldemail = $_POST["fldemail1"];


		//update in DB
		$query="UPDATE tblusers SET email ='$fldemail' where username='$userid'";
								...
								<div class="row">
									...
									<div class="col-lg-6 form-group">
									 ...
									 ?>
										...
										<h5>Current Email</h5>
										<input name="fldcurrent" value ="<?php echo $row['email'];?>" class="common-input mb-20 form-control" required="" type="email" readonly>
									 <?php
										}	
									...
									<div class="col-lg-6 form-group">
										<h5>New Email</h5>
										<input name="fldemail1" placeholder="Enter New Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Password'" class="common-input mb-20 form-control" required="" type="email" minlength="8" required>
										<h5>Confirm Email</h5>
										<input name="fldemail2" placeholder="Confirm Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Confirm Password'" class="common-input mb-20 form-control" required="" type="email" minlength="8" required>
