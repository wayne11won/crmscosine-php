   ...
   // define variables and set to empty values
	{
		...
		$query="INSERT INTO tblproduct (product_name, price)
		...
		<body>	
			...
			<div class="contact-page-area section-gap">
				...
				<div class="centerItem">
					<h3 class="text-heading">Add Product</h3>
                </div>				
					<div class="rowForm">
						<div class="col-lg-8">
							<form class="form-area " action="" method="post" class="contact-form text-right">
								<div class="row">
									...
									<div class="col-lg-6 form-group">
										...
										<input name="fldproduct" placeholder="Enter Product Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Product Name'" class="common-input mb-20 form-control" required="" type="text">
									</div>
									<div class="col-lg-6 form-group">
										<input name="fldprice" placeholder="Enter the Price" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter the Price'" class="common-input mb-20 form-control" required="" type="number">
