<?php
   ...
   // define variables and set to empty values
	{
		$getID =  $_GET['aid'];
		$product   = $_POST['fldproduct'];
		$price   = $_POST['fldprice'];
		
		
		$query="UPDATE tblproduct SET PRODUCT_NAME ='$product', price = '$price' where prdID='$getID'";
           $result = $db->query($query);
			if(! $result)
			 ...
			 {
				 echo "<script>alert('SUCCESSFULLY UPDATED'); window.location.href = 'product'; </script>";
			 }
		...
		<body>	
			...
			<div class="contact-page-area section-gap">
				...
				<div class="centerItem">
					<h3 class="text-heading">Update Product</h3>
                </div>				
					<div class="rowForm">
						<div class="col-lg-8">
							<form class="form-area " action="" method="post" class="contact-form text-right">
								<div class="row">
									...
									<?php
									$category = $_GET['aid'];
									$query = "SELECT product_name as PRODUCT, PRICE FROM tblproduct where prdid='$category'";
									$result = $db->query($query);
									...
									{
										echo "<input name='fldproduct' class='common-input mb-20 form-control' required='' type='text' value='". $row['PRODUCT'] ."'>";
									...
									<?php
										echo "<input name='fldprice' class='common-input mb-20 form-control' required='' type='number' value='". $row['PRICE'] ."'>";
									    }
									?>	
																				
										<button type ="update" name="update" class="genric-btn primary circle mt-30" style="float: right;">Update</button>
