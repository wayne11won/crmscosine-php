							...
							<form class="form-area " action="" method="post" class="contact-form text-right">
								<div class="row">
									...
									<div class="col-lg-6 form-group">
									 <?php
									    $id = $_SESSION['id'];
										$query = "SELECT username, Name_first, Name_Last, Email
									    FROM tblusers 
										where id='$id'";
									 ...
									 ?>
										<h5>Username</h5>
										<input name="fldusername" class="common-input mb-20 form-control" required="" type="text"  value ="<?php echo $row['username'];?>" readonly > <br/>
										
										<h5>Email</h5>
										<input name="fldemail" class="common-input mb-20 form-control" required="" type="text"  value ="<?php echo $row['Email'];?>" readonly > <br/>
										 ...
										 <h5>First Name</h5>
										 <input name="fldfirstname" class="common-input mb-20 form-control" required="" type="text"  value ="<?php echo $row['Name_first'];?>" readonly > <br/>
										
										 <h5>Last Name</h5>
										<input name="fldlastname" class="common-input mb-20 form-control" required="" type="text"  value ="<?php echo $row['Name_Last'];?>" readonly > <br/>
